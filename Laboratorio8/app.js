...
rl.question("Ingresa los números separados por comas: ", (numeros) => {
  let arreglo = numeros.split(",").map(Number);
  let promedio = calcularPromedio(arreglo);
  console.log("El promedio es: " + promedio);
  rl.question("Ingresa un pedazo de texto: ", (texto) => {
    let textito = texto;
    filesystem.writeFileSync("TuTexto.txt", textito);
    console.log("Se ha creado un archivo con el texto que ingresaste");
    bubbleSort(arreglo);
